    ...
    return [
      ...
      },
      {
        ...
        config: {
          ...
          notes: 'Get corporate entities from db. Submitting name and address acts as an AND statement',
          tags: ['api', 'Corps Search'],
          validate: {
            query: corpsearchModels.apiCorpsQuery,
          }
        }
      },
      {
        ...
        config: {
          ...
          tags: ['api', 'Corps Search'],
          validate: {
            payload: corpsearchModels.apiProcessSearchables,
          }
        }
      },
    ];
